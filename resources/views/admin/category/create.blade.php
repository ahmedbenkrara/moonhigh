...
<div id="app" class="mr-auto sm:w-[calc(100%-40px)] md:w-[calc(100%-250px)] bg-[white] h-fit min-h-screen px-[50px] pt-[30px]">
    ...
    <form action="{{ url('/categories/create') }}" method="POST" class="w-full h-fit block rounded-md mt-[60px] px-[40px] pb-[60px]">
        @csrf
        <h1 class="text-[20px] font-[600] text-[#2f3334]">تصنيف جديد</h1>
        ...
        <div class="my-4">
          ...
          <input type="text" name="name" value="{{ old('name') }}" class="w-full border h-fit text-[15px] px-4 py-2 rounded-md bg-[#f0f0f041] mt-2 outline-none">
        </div>
